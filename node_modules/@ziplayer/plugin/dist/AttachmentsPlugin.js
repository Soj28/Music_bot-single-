...
export class AttachmentsPlugin extends BasePlugin {
    ...
    opts;
    defaultAllowedExtensions = ["mp3", "wav", "ogg", "m4a", "flac", "aac", "wma", "opus", "webm"];
    /**
    ...
    async getStream(track) {
        ...
        try {
            ...
            return {
                stream,
                type: this.getStreamType(contentType, track.metadata?.extension),
                metadata: {
                    ...track.metadata,
                    contentType,
    ...
    extractRemoteFilename(url, headers) {
        // content-disposition
    ...
    async validateAudioFile(buffer, expectedExtension) {
        try {
