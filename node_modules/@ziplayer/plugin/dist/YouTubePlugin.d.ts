...
export declare class YouTubePlugin extends BasePlugin {
    ...
    private downloadWithYoutubei;
    private downloadWithSabr;
    getSabrDL(track: Track, id: string, signal?: AbortSignal): Promise<{
        stream: Readable;
        format: {
            mimeType: string;
            itag: number;
