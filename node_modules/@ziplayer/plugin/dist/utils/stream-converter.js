...
export async function webStreamToNodeStream(webStream, highWaterMark = 64 * 1024, seekBytes = 0, signal) {
...
export function calculateSeekBytes(positionMs, bitrateKbps = 128) {
